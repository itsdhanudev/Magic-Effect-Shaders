...
public class DirectionalBlur extends MaterialShader {
  ...
  public String getShaderName() {
    return "CustomShaders/DirectionalBlur";
  }
  ...
  void start() {
    ...
    VertexShader vs = VertexShader.loadFile(this, "DirectionalBlurVertex");
    FragmentShader fs = FragmentShader.loadFile(this, "DirectionalBlurFragment");
  ...
  void render(OGLES ogles, Camera camera, MSRenderData renderData) {
    ...
    ogl.uniformFloat("u_Angle", angle);
    ogl.uniformFloat("u_Distance", distance);
